<div class="uploads index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('fdir');?></th>
			<th><?php echo $this->Paginator->sort('ftype');?></th>
			<th><?php echo $this->Paginator->sort('fsize');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $upload['Upload']['fname']; ?>&nbsp;</td>
		<td><?php echo $upload['Upload']['fdir']; ?>&nbsp;</td>
		<td><?php echo $upload['Upload']['ftype']; ?>&nbsp;</td>
		<td><?php echo $upload['Upload']['fsize']; ?>&nbsp;</td>
		<td><?php echo $upload['Upload']['model']; ?>&nbsp;</td>
