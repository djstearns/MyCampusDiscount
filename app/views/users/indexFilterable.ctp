<div class="users index">
    <?php echo $this->Form->create('User', array('action' => 'index', 'id' => 'filters')); ?>
	...
	<tr>
        ...
        <?php
         //******This area is for an automated form*****
         ?>
         <tr>
         
              <?php echo $this->Filter->form('User', array('username')) ?>
                <td>
        ...
        <?php
         //******This area is for an manual form*****
         ?>
            <tr>
                <td></td>
